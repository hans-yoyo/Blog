...
1.在github上创建分支,如hexo

2.github上修改项目的默认分支为hexo

![image](个人博客操作笔记/0101.png)

3.clone项目到本地目录下
```bash
git clone https://github.com/hyman213/hyman213.github.io.git
```

4.执行git命令, 将文科原文保存到分支hexo上
```bash
git remote add origin https://github.com/hyman213/hyman213.github.io.git
git add .
...
deploy:
  type: git
  repository: git@github.com:hyman213/hyman213.github.io.git
  branch: master
```
